...
{
    public partial class rastgele2dakika : Form
    {
        public rastgele2dakika()
        {
            InitializeComponent();
        }
        int sayac = 0;
        ...
        private void rastgele2dakika_Load(object sender, EventArgs e)
        {
        ...
        private void rastgele2dakika_FormClosed(object sender, FormClosedEventArgs e)
        {
        }
        private void ac()
        {
